...
def test_median_imputation_total_charges():
    ...
    data = pd.DataFrame({
        'TotalCharges': [100.0, 200.0, np.nan, 400.0, 500.0]
    })
    expected_median = data['TotalCharges'].median()  # Median of [100, 200, 400, 500] = 300.0
...
def test_iqr_outlier_capping():
    ...
    data = pd.DataFrame({
        'MonthlyCharges': [20.0, 25.0, 30.0, 35.0, 40.0, 45.0, 50.0, 55.0, 60.0, 1000.0, -500.0]
    })
